...
Set up PrismMCP and connect your first AI agent.

| Guide | What it covers |
|---|---|
| [Installation](installation.md) | Where to get the build, plugin setup, optional Pro activation |
...
For advanced setup, see the [Security and Privacy](../guides/security-and-privacy.md) and [HTTP Transport](../guides/http-transport.md) guides.
