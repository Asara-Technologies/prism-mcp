...
| **PIE** | Start, stop | ✓ | ✓ |
| **AI behavior authoring** | Blackboards plus Behavior Tree shells, bindings, composites, native tasks, decorators, and services | ✓ | ✓ |
...
- **Behavior Trees / EQS.** Property update/removal/reorder/validation and EQS option/test editing. Blackboard schema authoring and early Behavior Tree shell/composite/task/decorator/service authoring are now shipped in Lite and Professional.
