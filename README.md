...
| **Blueprint-to-C++ conversion preview** | Selected Blueprint function/event migration, staged native files, compile/backmap recovery, Mode A surgical helpers, and Mode D native-parent scaffold/reparent/rollback guardrails | — | ✓ |
...
| **Blueprint-to-C++ preview** | Selected function/event migration, staged native files, compile/backmap recovery, Mode A surgical helpers, and Mode D native-parent scaffold/reparent/rollback guardrails | — | ✓ |
...
- **Blueprint-to-C++ conversion.** Professional preview coverage now includes selected function/event migration, staged native files, compile/backmap recovery, Mode A surgical helpers, and Mode D native-parent scaffold/reparent/rollback guardrails. Broader parity automation and arbitrary reflected component property replay remain follow-up scope.
