...
- **StateTree.** Component/AIComponent StateTree asset hierarchy plus schema-filtered node discovery/readback are now shipping in Lite and Professional. Node placement, evaluators, tasks, conditions, transitions, parameters, bindings, BP-base helpers, and compile diagnostics continue through the remaining StateTree slices.
