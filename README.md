...
| **PIE** | Start, stop | ✓ | ✓ |
| **AI behavior authoring** | Blackboards plus Behavior Tree shells, bindings, composites, native tasks, decorators, services, validation, subnode management, graph-node management, subtree references, BP-base helpers, and node properties | ✓ | ✓ |
...
- **Behavior Trees / EQS.** EQS option/test editing. Blackboard schema authoring and early Behavior Tree shell/composite/task/decorator/service/validation/subnode-management/property/graph-node/update/subtree-reference/BP-base-helper authoring are now shipped in Lite and Professional.
