...
- **StateTree.** Component/AIComponent StateTree asset hierarchy plus schema-filtered node discovery/readback/native placement/reorder/remove are now shipping in Lite and Professional. Node property patching, transitions, parameters, bindings, BP-base helpers, and compile diagnostics continue through the remaining StateTree slices.
