...
- **StateTree.** Component/AIComponent StateTree asset hierarchy plus schema-filtered node discovery/readback/native placement/reorder/remove/property patching/transition readback+creation/compile diagnostics are now shipping in Lite and Professional. Delegate/edit/remove transitions, parameters, bindings, and BP-base helpers continue through the remaining StateTree slices.
